/*
Your goal is to create a command-line utility that accepts a string and a "command" flag, 
then outputs the transformed result.
...
#include <ctype.h>
#include <string.h>
int main(int shitCount, char *shit[]){
   printf("%d", shitCount);
}
